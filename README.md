# Clicon - E-Commerce Web Application

**Clicon** — bu barcha turdagi mahsulotlarini onlayn sotib olish imkoniyatini beruvchi zamonaviy E-commerce veb-ilovasi. Loyiha React va zamonaviy kutubxonalar yordamida yaratilgan bo'lib, dinamik ma'lumotlar bilan ishlash va qulay UI/UX interfeysiga ega.
...
* **Icons:** React Icons (`lu` - Lucide Icons)
* **API / Data:** DummyJSON API (`/posts`, `/products`), Lorem Picsum
